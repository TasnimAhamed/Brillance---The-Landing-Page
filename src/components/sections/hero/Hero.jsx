...
function Hero() {
    return (
        <div
            className="w-full max-w-234.25 lg:w-234.25 flex flex-col justify-center items-center"
        >
            <div
            ...
            >
                ...
                {/* Subheading */}
                <div
                    className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-normal lg:leading-7 px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm"
                >

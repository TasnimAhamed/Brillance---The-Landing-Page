...
function Pricing() {
    return (
        ...
        >
            ...
            >
                <div
                    className="w-full max-w-146.5 px-6 py-5 shadow-none overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4"
                >
                    <Badge type="dollar" text="Plans & Pricing" />
                    <div
                        className="self-stretch text-center flex justify-center flex-col text-[#49423D] text-3xl md:text-5xl font-semibold leading-tight md:leading-15 tracking-tight"
                    >
